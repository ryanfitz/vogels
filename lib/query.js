...
Query.prototype.addKeyCondition = function (condition) {
  this.request.ExpressionAttributeNames  = _.merge({}, condition.attributeNames, this.request.ExpressionAttributeNames);
  this.request.ExpressionAttributeValues = _.merge({}, condition.attributeValues, this.request.ExpressionAttributeValues);
...
Query.prototype.buildKey = function () {
  ...
  return expressions.buildFilterExpression(key, '=', this.hashKey);
};
