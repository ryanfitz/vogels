...
Schema.types.JSON = function() {
  var jsonType = Joi.any();
...
Schema.prototype.JSON = function(attrName, options) {
    var attributeType = 'S';
    return internals.baseSetup(this, attrName, Schema.types.JSON(), attributeType, options);
};
