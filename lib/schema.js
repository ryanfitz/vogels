...
Schema.types.Object = function() {
  var objectType = Joi.object();
    
  objectType._type = 'object';
    
  return objectType;
}

Schema.types.ObjectSet = function() {
    var set = Joi.array().includes(Joi.any());
...
Schema.prototype.Object = function(attrName, options) {
    var attributeType = 'S';
    return internals.baseSetup(this, attrName, Schema.types.Object(), attributeType, options);
};

Schema.prototype.ObjectSet = function(attrName, options) {
    var attributeType = 'SS';
    return internals.baseSetup(this, attrName, Schema.types.ObjectSet(), attributeType, options);
}
